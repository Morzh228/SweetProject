...
sql_text = 'SELECT * FROM metric'
class postgres():  ### Надо разобраться с функциями в классах, чтоб можно было использовать переменные функции в main. global?
    try:
